  ...
  return (
    <>
      ...
      >
        {/* PLACA DE CONTRASTE */}
        <div
          className={`absolute top-0 left-0 h-full bg-white transition-all duration-700 ease-in-out z-0 ${
            isScrolled
              ? "w-0 opacity-0"
              : "w-[45%] md:w-[30%] lg:w-[24%] xl:w-[25%] 2xl:w-[25%] opacity-100 shadow-2xl"
          }`}
        ...
        <nav className="container mx-auto px-6 flex items-center justify-between relative z-10">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <NavHashLink
                  ...
                  className={`text-sm font-semibold uppercase tracking-widest transition-all relative py-2 group ${
                    isScrolled
                      ? isCurrent
                        ? "text-primary"
                        : "text-slate-800"
          ...
          <div className="flex items-center gap-4">
            ...
            <PrimaryButton
              ...
              to="/#contacto"
              scroll={(el) => scrollWithOffset(el)}
              className="hidden lg:block !py-2.5 !px-6 !text-sm"
            >
              {t("nav.contact")}
            </PrimaryButton>
                ...
                <div className="flex gap-4">
                  {languages.map((lang) => (
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-3 rounded-xl border-2 transition-all flex-1 justify-center font-bold ${
                        language === lang.code
