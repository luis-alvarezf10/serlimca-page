export default function GeneralButton({ children, onClick, className = '' }) {
  return (
    <button
      onClick={onClick}
      className={`bg-primary inline-flex items-center justify-center gap-3 2xl:text-lg group magnetic glow-effect xl:p-3 2xl:p-5 rounded-lg text-black font-bold
